...
## Usage
Open the terminal within your code editor, run the following command at the root of your project, then navigate through the prompts to manage your sql database.
```
node app.js
```
<br>
